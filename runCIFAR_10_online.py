...
import MyCNN_online as Net
"""# slimTrain import this"""
# import SlimTrainCnn_Kronecker_online as Net
...
for lr in [1e-2, 1e-3, 1e-4]:
    ...
    rls_train, rls_test, total_time = net.sgd_train(device, train_loader, train_loader2, test_loader, optimizer_SepSA, num_epo=args.epochs, separate=True)
...
with open('Result/CIFAR10/online/SepSA.pickle', 'wb') as f:
